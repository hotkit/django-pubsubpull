# Django settings for django_1_4 project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'pubsubpull',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'e0litu$@apn=(g94v#&amp;69^q9z6e*f8@g&amp;_g0)js3l@-xb*53+2'
...
WSGI_APPLICATION = 'django_1_4.wsgi.application'
